...
namespace StudioServer
{
    ...
    {
        private static List<ChatStructs.SingleAllChatMsg> AllChat = new List<ChatStructs.SingleAllChatMsg>();
        private static List<ChatStructs.SinglePrivateChatMsg> PrivateChat = new List<ChatStructs.SinglePrivateChatMsg>();
        ...
        internal static void LogChatsOnServerDevice()
        {
            ...
            lock (AllChat)
            {
                var tempChatList = new List<string>(AllChat.Count);
            ...
            var tempChatList2 = new Dictionary<string, List<string>>(PrivateChat.Count);
            ...
            if (PrivateChat.Count > 0)
            {
                ...
                var FileName = $"@{PrivateChat[0].Receiver}.log"; 
                var FileName2 = $"@{PrivateChat[0].Sender}.log";
