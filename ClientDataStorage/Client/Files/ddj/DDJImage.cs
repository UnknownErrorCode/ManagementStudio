...
@DCxDemo
DCxDemo commented on 20 Jul 2015

Alpha channel in DXT5 textures is decoded incorrectly.
Example: http://levelmod.webatu.com/test.png

also this line seems to be mistyped:
case PixelFormat.DXT4: rawData = this.DecompressDXT3(header, data, pixelFormat);
@micenote
micenote commented on 15 Mar 2016

DecompressDXT5
alphas[0] = temp[0];
can not load alpha channel.
@Paliha
Paliha commented on 24 Mar 2016
...
@tarek1500
tarek1500 commented on 19 Apr 2016

"uint bps = header.width * header.pixelformat.rgbbitcount / 8;"
"bps" will equal to 0 if the DDS file doesn't contain RGBbitcount.
@DCxDemo
DCxDemo commented on 8 May 2016 •
...
@Gerysis
Gerysis commented on 13 Aug 2016
...
@LeeC2202
LeeC2202 commented on 28 Sep 2018
