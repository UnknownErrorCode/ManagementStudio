...
{
    public class SkillEffect : BinaryFiles.PackFile.Media.Textdata.SkillEffectData
    {
        #region Constructors
        ...
        public bool ExistsEffectSets(string currentlySelectedBasicCode)
        {
            return Skilleffects.AllEffectSets.Exists(singleEffect => (string)singleEffect.SkillEffectID == currentlySelectedBasicCode);
        }
