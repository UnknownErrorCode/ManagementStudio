...
namespace ShopEditor.Interface
{
    internal class BlueShopTabWindow : Panel
    {
        ...
        internal bool Active { get => onFocus; set { onFocus = value; BackgroundImage = value ? ClientDataStorage.Client.Media.DDJFiles["Media\\interface\\ifcommon\\com_tab_on.ddj"].BitmapImage : ClientDataStorage.Client.Media.DDJFiles["Media\\interface\\ifcommon\\com_tab_off.ddj"].BitmapImage; } }
