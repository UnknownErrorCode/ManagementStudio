...
namespace PackFile.Utility
{
    public class Pk2Reader : Pk2Data
    {
        ...
        public override bool FileExists(string dir)
        {
            ...
            Pk2Folder tempFodler = new Pk2Folder() { subfolders = Pk2File.subfolders, files = Pk2File.files };
        ...
        public bool GetFilesInFolder(string filePath, out Pk2File[] filesInFolder)
        {
            Pk2Folder tempFolder = Pk2File;
        ...
        {
            Pk2File = new Pk2Folder() { name = Path.GetFileNameWithoutExtension(Pk2DataPath) };
            ...
            using (BinaryReader reader = new BinaryReader(File.OpenRead(Pk2DataPath)))
            {
                Pk2Folder tempFolder = new Pk2Folder() { parentFolder = Pk2File, name = Pk2File.name };
        ...
        private bool GenerateFolder(BinaryReader reader, long position, Pk2Folder parentFolder, out Pk2Folder unusedMainFolder)
        {
