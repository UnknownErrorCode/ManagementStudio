...
namespace PackFile.Utility
{
    internal class Pk2Class
    {
        ...
        private List<Pk2File> Files = new List<Pk2File>();
        private List<Pk2Folder> Folders = new List<Pk2Folder>();
        ...
        internal Pk2Class(string pk2FilePath)
        {
        ...
        private void ExtractSingleFile(string CreatePath, Pk2File file)
        {
        ...
        private byte[] GetFileByExtract(Pk2File file)
        {
            using (BinaryReader reader = new BinaryReader(fileStream))
            {
                reader.BaseStream.Position = file.position;
        ...
        private List<Pk2Folder> GetFoldersFromCurrentFolder()
        {
